locals {
  ...
  # token
  secret_name_key        = local.has_secrets ? var.atlantis_github_user_token != "" ? "ATLANTIS_GH_TOKEN" : "" : ""
  secret_name_value_from = local.has_secrets ? var.atlantis_github_user_token != "" ? var.atlantis_github_user_token_ssm_parameter_name : " " : ""

  # webhook
  secret_webhook_key = local.has_secrets || var.atlantis_github_webhook_secret != "" ? var.atlantis_github_webhook_secret != "" ? "ATLANTIS_GH_WEBHOOK_SECRET" : "" : ""
